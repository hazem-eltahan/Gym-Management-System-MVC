        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneCheck", "Phone NOT LIKE '%[^0-9]%' AND LEN(Phone) = 11 AND LEFT(Phone, 3) IN ('010', '011', '012', '015')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneCheck1", "Phone NOT LIKE '%[^0-9]%' AND LEN(Phone) = 11 AND LEFT(Phone, 3) IN ('010', '011', '012', '015')");
                });
